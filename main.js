...
window.onload = function(){
    ...
    // 自機の初期位置を修正
    crdx = screenCanvas.width / 2;
    crdy = screenCanvas.height - 20;
...
//    screenCanvas.addEventListener('mousedown', mouseDown, true);
    ...
    (function(){
        ...
        // 自機の位置を設定
        chara.position.x = crdx;
        chara.position.y = crdy;
...
//    // マウスカーソル座標の更新
//    crd.x = event.clientX - screenCanvas.offsetLeft;
//    crd.y = event.clientY - screenCanvas.offsetTop;
//}
